        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bodeguero = table.Column<bool>(nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoraCompra = table.Column<DateTime>(nullable: false),
                    Coste = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(nullable: false),
                    DenominacionOrigenId = table.Column<int>(nullable: true),
                    TipoVino = table.Column<int>(nullable: false),
                    Anada = table.Column<int>(nullable: false),
                    EdadVino = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vinos_Origenes_DenominacionOrigenId",
                        column: x => x.DenominacionOrigenId,
                        principalTable: "Origenes",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vinos_Pedidos_PedidoID",
                        column: x => x.PedidoID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vinos_DenominacionOrigenId",
                table: "Vinos",
                column: "DenominacionOrigenId");

            migrationBuilder.CreateIndex(
                name: "IX_Vinos_PedidoID",
                table: "Vinos",
                column: "PedidoID");
        }
